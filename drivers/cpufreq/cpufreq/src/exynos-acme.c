...
/* Include Rissu Driver */
#include "rsuntk_cpufreq.h"

static unsigned long arg_cpu_min_c1 = little_core_min_hz_val(); 
...
unsigned long arg_cpu_min_c2 = big_core_min_hz_val(); 
...
static unsigned long arg_cpu_max_c1 = little_core_max_hz_val();
...
unsigned long arg_cpu_max_c2 = big_core_max_hz_val();
